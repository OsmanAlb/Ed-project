...
const CreateCourses = () => {
	const options = ['3 Lesson', '2 Lesson', '1 Lesson']
	...
	return (
		<div className='flex flex-col text-12px leading-[22px] gap-[25px]'>
			...
			<div>
				...
				<p className='mb-[5px] text-[#181818]'>
			...
			<div>
				...
				<button className='p-[9px] w-full bg-[#FDFDFD] border-[1px] border-[#E0E0E0] rounded-[4px] text-[#181818]'>
					Algebraic Equations and Expressions
				</button>
			</div>
			<Uploader />
			<Button className='mt-[35px] w-full' variant='primary'>
				Upload
			</Button>
		</div>
	)
